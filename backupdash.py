...
dsn=cx_Oracle.makedsn('saprex5-scan','1638',service_name='BIPRD01')
...
fig=go.Figure(data=[
    go.Bar(name="Loaded to Dock",x=xdata,y=ydata,marker_color="Green",text="Dock",textposition='auto'),
    go.Bar(name="Picked",x=xdata,y=zdata,marker_color="Red",text="Picked",textposition='auto')
    ])
...
if __name__=='__main__':
    app.run_server(debug=False,host='10.80.91.137',port=8050)#True,use_reloader=False)
