...
#rint(sum_of_intervals([(1,10),(-100_000_001,100_000_000)])) # 2_000_000_000
...
#rint(sum_of_intervals([[randint(randint(-1_000_000_000,0),1),randint(1,randint(1,1_000_000_000))] for i in range(randint(1,10))]))
